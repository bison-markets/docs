...
<ResponseField name="yes_bid_uusdc" type="number" optional>
  Best bid price for YES in µUSDC
</ResponseField>

<ResponseField name="yes_ask_uusdc" type="number" optional>
  Best ask price for YES in µUSDC
</ResponseField>

<ResponseField name="no_bid_uusdc" type="number" optional>
  Best bid price for NO in µUSDC
</ResponseField>

<ResponseField name="no_ask_uusdc" type="number" optional>
  Best ask price for NO in µUSDC
</ResponseField>

<ResponseField name="last_price_uusdc" type="number" optional>
...
<Note>
All price fields are in µUSDC (microUSDC). To convert to USDC: `priceUSDC = priceUusdc / 1,000,000`

For example, `750000 µUSDC = 0.75 USDC` (75% probability).
</Note>
