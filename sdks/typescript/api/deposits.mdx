...
<ParamField path="vaultAddress" type="string" required>
  Address of the Bison vault contract
</ParamField>

<ParamField path="usdcAddress" type="string" required>
  Address of the USDC token contract
</ParamField>

<ParamField path="amount" type="number" required>
  Amount of USDC to deposit (in USDC, not wei)
</ParamField>
...
<ParamField path="amount" type="number" required>
  Amount of USDC to withdraw (in USDC, not wei). Must not exceed your deposited balance.
</ParamField>
...
- All amounts are in USDC (not wei), but the underlying contract uses 6 decimal places
