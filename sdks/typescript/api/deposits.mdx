...
The SDK provides `executeDepositFlow` and `executeWithdrawFlow`, and `getDepositedUsdcBalance` methods to deposit and withdraw USDC for trading on Bison. 
These methods handle all the necessary steps including asking for approvals and authorization signatures.
...
Withdraw USDC from your deposited balance.
