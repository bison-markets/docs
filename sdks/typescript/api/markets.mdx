...
console.log('  Vault address:', baseConfig.vaultAddress);
console.log('  USDC address:', baseConfig.usdcAddress);
...
// 1. Get system info to find contract addresses
const info = await client.getInfo();
const vaultAddress = info.chains.base.vaultAddress;
