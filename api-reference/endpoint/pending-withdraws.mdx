...
<ResponseField name="withdraws" type="array">
  ...
  <Expandable title="Withdrawal object properties">
    ...
    <ResponseField name="amountUusdc" type="number">
      Original scheduled withdrawal amount in µUSDC.
    </ResponseField>

    <ResponseField name="claimedAmountUusdc" type="number">
      Amount already claimed from this withdrawal in µUSDC.
    </ResponseField>

    <ResponseField name="remainingUusdc" type="number">
      Amount still available to claim in µUSDC.
    </ResponseField>
...
<ResponseField name="totalFillLocked" type="number">
  Total amount in `fill-locked` status in µUSDC.
</ResponseField>

<ResponseField name="totalUnclaimed" type="number">
  Total amount in `unclaimed` status in µUSDC.
</ResponseField>

<ResponseField name="totalAvailableUnclaimed" type="number">
